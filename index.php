...
<html lang="en">
  ...
  ?>
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  <div class="col-md act">
                    <img src="img/user1.png" class="img-fluid" width="245" height="245">
                    <br>
                    <a href="createuser.php"><button style="background-color : #2785C4;">Create a User</button></a>
                  </div>
                  <div class="col-md act">
                    <img src="img/transaction.jpeg" class="img-fluid" width="375" height="375">
                    <br>
                    <a href="transfermoney.php"><button style="background-color : #2785C4;">Make a Transaction</button></a>
                  </div>
                  <div class="col-md act">
                    <img src="img/transaction-history.jpg" class="img-fluid" width="245" height="245">
                    <br>
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Made by <b>Shubham Shah</b> <br>Shah Foundation</p>
      </footer>
